...
public class ModelTest {
	...
	public void testTransactions() throws InsufficientBalanceException {
		...
		Account account2 = new Account("Jim", "12345");
		account2.post(new DepositTransaction(1000));
		account2.post(new WithdrawalTransaction(200));
		account2.post(new PhoneBillPaymentTransaction("Vodafone", "5423345566", 96.50));
		assertEquals(account2.getBalance(), 703.50, 0.0001);
