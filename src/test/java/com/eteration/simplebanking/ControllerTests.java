...
class ControllerTests  {
    ...
    @Test
    public void givenId_CreditAndThenBillPaymentMoreGetException_thenReturnJson()
            throws Exception {
        Assertions.assertThrows( InsufficientBalanceException.class, () -> {
            Account account = new Account("Kerem Karaca", "17892");
            ...
            ResponseEntity<TransactionStatus> result2 = controller.billPayment( "17892", new BillPaymentTransaction(5000.0,"Gas"));
        });
    }

    @Test
    public void givenId_CreditAndThenPhoneBillPaymentMoreGetException_thenReturnJson()
            throws Exception {
        Assertions.assertThrows( InsufficientBalanceException.class, () -> {
            Account account = new Account("Kerem Karaca", "17892");
            ...
            ResponseEntity<TransactionStatus> result2 = controller.billPayment( "17892", new PhoneBillPaymentTransaction("Vodafone", "5551234567",5000.0));
        });
    }
